...
- _Preserved as a CSS Snippet_ -> **MagicUser Underline Effects**:
  ...
  - **Snippet**: `magicuser_underline_effects.css`
  - You can customize the effects using the standard Style Settings options, just like when they were built-in MagicUser features.
...
- Theme Style Settings options have a left border according to the color of the main Style Settings menu icon (Gold/Yellow, Blue, Purple and Orange).
...
- Updated minAppVersion to 1.13.0 (manifest.json).
